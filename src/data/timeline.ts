...
export const timelineData: Timelines = {
  start: [
    ...
    {
      type: "dialog",
      text: "どうしてこうなったんだろう。いつも平凡な生活に飽き飽きしていたじゃないか。",
    },
    { type: "dialog", text: "あんなことを。" },
    {
      type: "dialog",
      text: "事実だとすれば、俺は一体なんなんだ。考えても、次の瞬間覚えてないんじゃ、俺じゃない誰かだ。",
    },
    {
      type: "dialog",
      text: "奇妙なことはあった。時間の流れが変だったし、レンズ越しに見ているような、そういう感覚があった。",
    },
    {
      type: "dialog",
      text: "でも、本当に事実なんだろうか？誰かがそう思わそうとしてるだけなんじゃないのか？",
    },
    {
      type: "dialog",
      text: "まあ、どうでもいい。あと45秒もすればわかることだ。肉体に劇的な変化が起きて、あらゆる眠った精神を引き起こすだろう。本当の目覚めだ。",
    },
  ...
  home01: [
    {
      type: "dialog",
      text: "テレビを見ていた。ドアベルが鳴った。8時頃だ。宅配を頼んでいない。面倒な感じがした。",
    },
  ...
  choice01_a02: [
    {
      type: "dialog",
      text: "しばらくドアベルが鳴らされた後、静かになった。その後、この出来事について思い出すことはなかった。",
    },
    { type: "sceneTransition", key: "ending" },
  ],
};
